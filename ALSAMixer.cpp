...
{
    const AudioSystem::audio_routes device;
    const char         *propName;
...
mixerMasterProp[SND_PCM_STREAM_LAST+1] =
        ALSA_PROP(AudioSystem::ROUTE_ALL, "master", "PCM", "Capture");

static alsa_properties_t
mixerProp[][SND_PCM_STREAM_LAST+1] = {
    ALSA_PROP(AudioSystem::ROUTE_EARPIECE, "earpiece", "Earpiece", "Capture"),
    ALSA_PROP(AudioSystem::ROUTE_SPEAKER, "speaker", "Speaker",  ""),
    ALSA_PROP(AudioSystem::ROUTE_HEADSET, "headset", "Headphone", "Capture"),
    ALSA_PROP(AudioSystem::ROUTE_BLUETOOTH_SCO, "bluetooth.sco", "Bluetooth", "Bluetooth Capture"),
    ALSA_PROP(AudioSystem::ROUTE_BLUETOOTH_A2DP, "bluetooth.a2dp", "Bluetooth A2DP", "Bluetooth A2DP Capture"),
#ifdef HAVE_FM_ROUTING
    ALSA_PROP(AudioSystem::ROUTE_FM, "fm", "FM", ""),
#endif
    ALSA_PROP(static_cast<AudioSystem::audio_routes>(0), "", NULL, NULL)
};
