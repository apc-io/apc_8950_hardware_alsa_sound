...
static const device_suffix_t deviceSuffix[] = {
        {AudioSystem::ROUTE_EARPIECE,       "_Earpiece"},
        {AudioSystem::ROUTE_SPEAKER,        "_Speaker"},
        {AudioSystem::ROUTE_BLUETOOTH_SCO,  "_Bluetooth"},
        {AudioSystem::ROUTE_HEADSET,        "_Headset"},
        {AudioSystem::ROUTE_BLUETOOTH_A2DP, "_Bluetooth-A2DP"},
#ifdef HAVE_FM_ROUTING
        {AudioSystem::ROUTE_FM,             "_FM"},
#endif
};
